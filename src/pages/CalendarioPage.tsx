              ...
              <CardContent className="p-0">
                <div className="flex flex-col md:flex-row">
                  <div className="bg-primary text-primary-foreground p-8 flex flex-col items-center justify-center text-center min-w-[160px]">
                    ...
                    <span className="font-bold text-xl leading-tight">{event.date.split(',')[0]}</span>
                    <span className="text-xs opacity-80 uppercase tracking-widest">{event.date.split(',')[1]}</span>
                  </div>
                  <div className="p-8 flex-1">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <button title="Lembre-me" className="p-2 rounded-full hover:bg-accent transition-colors">
